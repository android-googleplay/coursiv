...
import { Check, Home, Lightbulb, Play, Volume2 } from "lucide-react";
...
import { clearAnswerScrollRoom, scrollResultIntoView } from "@/components/shared/use-scroll-to-result";
...
export function GenericLessonPlayer(){
  ...
  useEffect(()=>{if(step!==2||choice===null)return;let spacedMain:HTMLElement|null=null;const frame=requestAnimationFrame(()=>{spacedMain=scrollResultIntoView(document.querySelector<HTMLElement>(".generic-lesson .generic-choices p"))});return()=>{cancelAnimationFrame(frame);clearAnswerScrollRoom(spacedMain)}},[choice,step]);
